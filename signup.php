			           ...
			           <form action="signup.php" method="POST">
						...
						<div class="form-group">
							<label for="username">Email:</label>
								<input id="username" type="email"placeholder="Email"class="form-control"name="email" required value="<?php echo $email; ?>"/>
							
						</div>
						<div class="form-group">
							<label for="password">Password:</label>
								<input id="password" type="password"placeholder="password"class="form-control" name="password_1"required />
							
						</div>
						
						<div class="form-group">
							<label for="confirm-password">confirm-Password:</label>
								<input id="confirm--password" type="password"placeholder="Confrom password"class="form-control"name="password_2"required  />
